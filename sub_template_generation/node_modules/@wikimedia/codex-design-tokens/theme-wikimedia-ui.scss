...
$font-size-base: 16px; // This token is targeted exclusively for font-size derived calculations. Apply `font-size-medium` and similar for component font size property use.
